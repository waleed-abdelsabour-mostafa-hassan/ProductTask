        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="active treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>Saless</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{route('admin.sales.create')}}"><i class="fa fa-circle-o"></i> Create</a></li>
                        <li><a href="{{route('admin.sales.index')}}"><i class="fa fa-circle-o"></i> Index</a></li>
                    </ul>
                </li>
